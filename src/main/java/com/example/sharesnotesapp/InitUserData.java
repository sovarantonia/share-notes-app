...
public class InitUserData implements CommandLineRunner {
    ...
    @Autowired
    public InitUserData(UserRepository userRepository, PasswordEncoder passwordEncoder, NoteRepository noteRepository, TagRepository tagRepository, RequestRepository requestRepository, ShareRepository shareRepository) {
